...
const Result = () => {
    ...
    return (
        <motion.form onSubmit={onSubmitHandler} action="" className='flex flex-col min-h-[90vh] justify-center items-center'
        ...
        >
            <div>
                <div className='relative'>
                    ...
                    <span className={`absolute bottom-0 right-0 left-0 h-1 bg-blue-500 ${loading ? 'w-full transition-all duration-[10s]' : 'w-0'}`}></span>
                </div>
